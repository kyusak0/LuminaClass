...
import { Book, BotIcon, ChevronLeft, ChevronRight, Dock, Home, Menu, Pencil, Tags, User } from "lucide-react";
...
export default function Navigation({ content }: NavProps) {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-50">
            ...
            >
                <header className={`fixed top-0 right-0 left-0 bg-white shadow-sm z-10 transition-all duration-300 ${isSidebarOpen ? 'ml-[256px]' : 'ml-5'} max-lg:ml-0`}
                >
                ...
                <div className="p-20 max-lg:px-0">
                    {content}
                </div>
            </main>
        </div >
